...
describe("portfolio research history", () => {
  test("renders longitudinal observations and immutable decisions", () => {
    const html = renderToStaticMarkup(<ResearchHistorySummary history={{
      runs: [{ id: "run_1", projectId: "prj_1", researchType: "kdp.niche", trigger: "manual", status: "completed", requestPayload: {}, requestDigest: "request", startedAt: "2026-08-01T10:00:00.000Z", completedAt: "2026-08-01T10:05:00.000Z", createdAt: "2026-08-01T10:00:00.000Z" }],
      snapshots: [{ id: "snap_1", projectId: "prj_1", runId: "run_1", sequence: 1, state: "complete", capturedAt: "2026-08-01T10:03:00.000Z", sealedAt: "2026-08-01T10:04:00.000Z", supersedesSnapshotId: null, canonicalPayload: {}, canonicalPayloadDigest: "payload", diagnosticSummary: {} }],
      observations: [
